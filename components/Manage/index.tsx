...
import { IoHammer, IoHammerOutline, IoOptions } from 'react-icons/io5';
...
const Manage = () => {
  ...
  return (
    <>
      <span onClick={openModal} className='cursor-pointer font-normal text-sm text-center mr-4 l-1 h-7 flex items-center'>
